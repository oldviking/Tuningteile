...
namespace Tuningteile.Migrations
{
    ...
    [Migration("20211020103412_add_min_size")]
    partial class add_min_size
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tuningteile.Models.compatibility", b =>
                {
            ...
            modelBuilder.Entity("Tuningteile.Models.compatibility", b =>
                {
                    b.HasOne("Tuningteile.Models.Model", "Model")
                        .WithMany("compatibilities")
                        .HasForeignKey("ModelID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tuningteile.Models.TuningPart", "TuningPart")
                        .WithMany("compatibilities")
